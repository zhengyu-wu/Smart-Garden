...
//antd
import { Modal, Table, Icon, Switch, Radio, Form, Divider, Input, Layout, Row, Col, Popconfirm, Button, List, Avatar } from 'antd';
    ...
    handleAddSensor = (gardenId) => {
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                //params.append('sensorState',values.length);
                        ...
                        <div className="garden-list">
                            <List style={{textAlign:'center'}}
                                ...
                                >
                                    ...
                                    title={<a>{"Garden:"+item.gardenId}</a>}
                                    ...
                                    <Form className="addSensor-form" onSubmit={()=>this.handleAddSensor(this.state.targetGardenId)}>
                                        ...
                                        >
                                            {getFieldDecorator('sensorType', {
                                                    rules: [{ required: true, message: 'Please input sensorType!', whitespace: true }],
                                                })(
                                                <Input prefix={<Icon type="user" style={{ color: 'rgba(0,0,0,.25)' }} />}
