...
render() {
    ...
    {
        return (
            <Chart height={window.innerHeight} padding={[ 60, 60, 100, 60 ]} data={sensorData} scale={cols_humidity} forceFit>
            <Axis name="sendTime" />
    ...
    {
        return (
            <Chart height={window.innerHeight} padding={[ 60, 60, 100, 60 ]} data={sensorData} scale={cols_temperature} forceFit>
            <Axis name="sendTime" />
            <Axis name="temperature" />
            <Tooltip crosshairs={{type : "y"}}/>
            <Geom type="line" position="sendTime*temperature" size={2} />
