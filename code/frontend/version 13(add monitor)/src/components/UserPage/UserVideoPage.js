...
import VideoPage from '../SensorImg/VideoPage';
            ...
            <Layout>
                <Layout>
                        ...
                        <div className="garden-list">
                            <List style={{textAlign:'center'}}
                                ...
                                <List.Item key={item.gardenId} 
                                    actions={[
                                        <Switch checkedChildren="ON" unCheckedChildren="OFF" defaultChecked={false} onChange={()=>this.switchAutoWatering(item.gardenId)}  />,
                                        <ButtonGroup>
                    ...
                    <Content style={{ background: '#fff'}} >
                        {/*此处放喷头坐标图*/}
                        <VideoPage currentGardenLength = {this.state.currentGardenLength}
