...
The following URLs are considered part of this conversation:
	http://localhost:8080/fakeData/generateDataWithGardenId?gardenId=232
...
The following URLs are considered part of this conversation:
	http://localhost:8080/temperature/getLastTempDataByGardenId?gardenId=232
...
The following URLs are considered part of this conversation:
	http://localhost:8080/nozzles/getNozzleByNozzleId?nozzleId=240
	http://localhost:8080/nozzles/getNozzleByNozzleId?nozzleId=239
	http://localhost:8080/nozzles/getNozzleByNozzleId?nozzleId=238
	http://localhost:8080/nozzles/getNozzleByNozzleId?nozzleId=237
	http://localhost:8080/nozzles/getNozzleByNozzleId?nozzleId=236
...
The following URLs are considered part of this conversation:
	http://localhost:8080/nozzles/modifyStateByNozzleId
...
The following URLs are considered part of this conversation:
	http://localhost:8080/temperature/getLast15TempDataBySensorId?sensorId=234
...
The following URLs are considered part of this conversation:
	http://localhost:8080/humidity/getLast15HumiDataBySensorId?sensorId=233
