...
class ModifyNozzlePosition extends React.Component{
        ...
        return(
            <View>
                ...
                <Button type={'primary'} onClick={()=>{
                    ...
                    axios.post('http://192.168.56.1:8080/nozzles/modifyPositionByNozzleId',qs.stringify(params))
                        .then(()=>{
...
export default ModifyNozzlePosition;